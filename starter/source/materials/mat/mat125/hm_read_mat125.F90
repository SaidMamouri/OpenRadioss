...
#include  "my_real.inc"
 ...
 !-----------------------------------------------
      ...
      my_real                                                         &
         ...
         ef22t,ef22c,ef33t,ef33c,fac,tsize,tsmd,g31,                  &
          fcut,efs,ms,als,                                            &
...
!card2 - young's moduli + shear moduli
      ...
      call hm_get_floatv('mat_soft'  ,soft      ,is_available, lsubmodel, unitab)
      call hm_get_intv('mat_fs'    ,fs    ,is_available, lsubmodel)
!card3 - shear modulus +
      call hm_get_floatv('mat_g12'   ,g12      ,is_available, lsubmodel, unitab)
      call hm_get_floatv('mat_g23'   ,g23      ,is_available, lsubmodel, unitab)
      call hm_get_floatv('mat_g13'   ,g13      ,is_available, lsubmodel, unitab)
!card4 -  poisson's ratio
      ...
      call hm_get_floatv('mat_nu13'  ,nu13     ,is_available, lsubmodel, unitab) 
!card5 - dir 11 tention 
      call hm_get_floatv  ('mat_em11t'    ,em11t      ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_xt'       ,xt         ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_slimt1'   ,slimt1     ,is_available, lsubmodel, unitab)
      call hm_get_intv ('ifunc_le11t'  ,ifem11t     ,is_available, lsubmodel)
      call hm_get_intv ('ifunc_lcxt'   ,ifxt       ,is_available, lsubmodel)
! card6 - dir 11 compression 
      call hm_get_floatv  ('mat_em11c'    ,em11c      ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_xc'       ,xc         ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_slimc1'   ,slimc1     ,is_available, lsubmodel, unitab)
      call hm_get_intv  ('ifunc_le11c'  ,ifem11c   ,is_available, lsubmodel)
      call hm_get_intv  ('ifunc_lcxc'   ,ifxc     ,is_available, lsubmodel)  
!card7 - dir 22 tention 
      call hm_get_floatv  ('mat_em22t'    ,em22t      ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_yt'       ,yt         ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_slimt2'   ,slimt2     ,is_available, lsubmodel, unitab)
      call hm_get_intv ('ifunc_le22t'  ,ifem22t     ,is_available, lsubmodel)
      call hm_get_intv ('ifunc_lcyt'   ,ifyt       ,is_available, lsubmodel)
! card8 - dir 22 compression 
      call hm_get_floatv  ('mat_em22c'    ,em22c      ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_yc'       ,yc         ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_slimc2'   ,slimc2     ,is_available, lsubmodel, unitab)
      call hm_get_intv  ('ifunc_le22c'  ,ifem22c   ,is_available, lsubmodel)
      call hm_get_intv  ('ifunc_lcyc'   ,ifyc     ,is_available, lsubmodel) 
!card9 - dir 33 tention  only for solid
      call hm_get_floatv  ('mat_em33t'    ,em33t      ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_zt'       ,zt         ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_slimt3'   ,slimt3     ,is_available, lsubmodel, unitab)
      call hm_get_intv ('ifunc_le33t'  ,ifem33t     ,is_available, lsubmodel)
      call hm_get_intv ('ifunc_lczt'   ,ifzt       ,is_available, lsubmodel)
! card10- dir 33 compression only for solid
      call hm_get_floatv  ('mat_em33c'    ,em33c      ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_zc'       ,zc         ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_slimc3'   ,slimc3     ,is_available, lsubmodel, unitab)
      call hm_get_intv  ('ifunc_le33c'  ,ifem33c   ,is_available, lsubmodel)
      call hm_get_intv  ('ifunc_lczc'   ,ifzc     ,is_available, lsubmodel)   
!card11 - shear 12 
      call hm_get_floatv  ('mat_gamma'   ,gamma     ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_tau'     ,tau       ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_ems'     ,ems       ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_sc'      ,sc        ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_slims'   ,slims     ,is_available, lsubmodel, unitab)
!card12 - strain rate dependency (optional)
      call hm_get_intv  ('ifunc_lcgamma'  ,ifgamma   ,is_available, lsubmodel)
      call hm_get_intv  ('ifunc_lctau'    ,iftau     ,is_available, lsubmodel)
      call hm_get_intv  ('ifunc_lems'     ,ifems     ,is_available, lsubmodel)
      call hm_get_intv  ('ifunc_lcs'      ,ifsc     ,is_available, lsubmodel)
!card13 - shear 13 for solid 
      call hm_get_floatv  ('mat_gamma2'   ,gamma2     ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_tau2'     ,tau2       ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_ems13'    ,ems13      ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_sc13'     ,sc13       ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_slims13'  ,slims13    ,is_available, lsubmodel, unitab)
!card14 - strain rate dependency (optional)
      call hm_get_intv  ('ifunc_lcgamma2'  ,ifgamma2   ,is_available, lsubmodel)
      call hm_get_intv  ('ifunc_lctau2'    ,iftau2     ,is_available, lsubmodel)
      call hm_get_intv  ('ifunc_lems13'     ,ifems13     ,is_available, lsubmodel)
      call hm_get_intv  ('ifunc_lcs13'      ,ifsc13      ,is_available, lsubmodel)
!card15- shear 13 for solid 
      call hm_get_floatv  ('mat_gamma3'   ,gamma3     ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_tau3'     ,tau3       ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_ems23'    ,ems23      ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_sc23'     ,sc23       ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_slims23'  ,slims23    ,is_available, lsubmodel, unitab)
!card16 - strain rate dependency (optional)
      call hm_get_intv  ('ifunc_lcgamma3'  ,ifgamma3   ,is_available, lsubmodel)
      call hm_get_intv  ('ifunc_lctau3'    ,iftau3     ,is_available, lsubmodel)
      call hm_get_intv  ('ifunc_lems23'     ,ifems23     ,is_available, lsubmodel)
      call hm_get_intv  ('ifunc_lcs23'      ,ifsc23      ,is_available, lsubmodel)   
!card17    
      call hm_get_floatv  ('mat_epsf'   ,gammaf     ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_epsr'   ,gammar       ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_tsmd'   ,tsmd      ,is_available, lsubmodel, unitab)       
!card18
      call hm_get_intv  ('ifunc_erods'        ,iferods  ,is_available, lsubmodel)  
      call hm_get_floatv  ('mat_erods'   ,erods       ,is_available, lsubmodel, unitab)
      call hm_get_floatv  ('mat_tsize'   ,tsize       ,is_available, lsubmodel, unitab)       
...
!-----------------------------------------
          ...
          pm(24) = c1
          pm(26) = five_over_6
          pm(27) = sqrt(c1/rho0)     !  mat_param%ssp
